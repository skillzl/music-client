...
module.exports = {
    ...
    async execute(interaction, client) {
        if (interaction.isChatInputCommand()) {
            ...
            if (interaction.values[0] == "client_help_category_general") {
                embed.setAuthor({ name: "Client Help" });
                embed.setTitle("General Commands");
                embed.setDescription("**/help** - Shows all client's commands available.\n**/stats** - View some bot statistics.\n**/botinfo** - View information about bot.");
            } else if (interaction.values[0] == "client_help_category_music") {
                embed.setAuthor({ name: "Client Help" });
            ...
            } else if (interaction.values[0] == "client_help_category_effects") {
                embed.setAuthor({ name: "Client Help" });
